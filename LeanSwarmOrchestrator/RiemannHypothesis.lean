/-
  Riemann Hypothesis formal statements & equivalent certificate formulations:
...
-- Robin inequality certificate structure
...
-- Verification lemma without sorry: reflexivity on explicit small Robin check
